...
const ROUTES = [
  { path: '/coaching', title: 'Coaching — MWB Performance', desc: '1:1 online coaching with Micah Barker, NZ-wide — custom programs, weekly check-ins, DM support. In-person Christchurch from September. No lock-in.' },
  ...
  { path: '/personal-trainer-christchurch', title: 'Personal Trainer Christchurch — MWB Performance | Micah Barker', desc: 'Looking for a personal trainer in Christchurch? Micah Barker coaches beginners and stalled lifters 1:1 online — in-person Christchurch sessions from September. Free intro call, no lock-in.',
    ld: { '@context': 'https://schema.org', '@graph': [
      { '@type': 'FAQPage', mainEntity: [
        { '@type': 'Question', name: 'Where in Christchurch do you train clients?', acceptedAnswer: { '@type': 'Answer', text: 'In-person sessions launch throughout Christchurch in September — the waitlist is open now. Coaching is fully online until then and starts immediately.' } },
